...
int MidSpeed = 15;//Integer variable to store the train's initial speed(when leaving or arriving at the station).

int MaxSpeed = 30;//Integer variable to store the train's maximum speed(after leaving the station).
